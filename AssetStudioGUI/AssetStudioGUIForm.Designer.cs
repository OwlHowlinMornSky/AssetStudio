...
namespace AssetStudioGUI {
	partial class AssetStudioGUIForm {
		...
		private void InitializeComponent() {
			...
			previewPanel1 = new Controls.PreviewPanel();
			...
			// 
			ui_main_splitContainer0.Panel2.Controls.Add(previewPanel1);
			...
			// previewPanel1
			// 
			resources.ApplyResources(previewPanel1, "previewPanel1");
		...
		private Controls.PreviewPanel previewPanel1;
	}
}
